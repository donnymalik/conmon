                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                foreach($alat_berat as $obj){
                                    $no++;
                                ?>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12" style="padding: 6px">
                                        <a class="btn btn-lg btn-info btn-block" href="<?= base_url('dashboard/list_alat_berat/'.$obj -> section.'/'.$obj -> egi) ?>"><?= $obj -> egi ?></a>
                                    </div>
                                <?php
                                }
                                ?>                                    
