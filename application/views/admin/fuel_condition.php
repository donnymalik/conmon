            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Record Fuel Condition </h3>
                        <div class="breadcrumb-wrapper">
                            <!--<span class="label">You are here:</span>-->
                            <ol class="breadcrumb">
                                <li class="active"> Record Fuel Condition </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-control">
                                    <a href="<?= base_url('admin/import_fuel_condition') ?>" class="btn btn-primary">
                                        <span class="fa fa-upload"></span> Import Record Fuel Condition...
                                    </a>
                                    <a href="<?= base_url('admin/kosongkan_data_fuel_condition') ?>" onclick="return confirm('Yakin kosongkan? Data tidak dapat dikembalikan.')" class="btn btn-default">
                                        <span class="fa fa-trash"></span> Kosongkan Record Fuel Condition
                                    </a>
                                </div>                                
                                ...
                                <table id="demo-dt-selection" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Sulfur content (result | max)</th>
                                            <th>Water content (result | max)</th>
                                            <th>Particle count (result | max)</th>
                                            <th>Particle count (status)</th>
                                            <th>Comment</th>
                                            <th>Fame content (result | min| max)</th>
                                            <th>Fame content (status)</th>
                                            <th>Imported at</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        $no=0;
                                        foreach($data_fuel_condition as $obj){
                                            $no++;
                                        ?>
                                        <tr>
                                            <td><?= $no ?></td>
                                            ...
                                            <td><?= $obj -> sulfur_content_result ?> | <?= $obj -> sulfur_content_max ?></td>
                                            <td><?= $obj -> water_content_result ?> | <?= $obj -> water_content_max ?></td>
                                            <td><?= $obj -> particle_count_result ?> | <?= $obj -> particle_count_max ?></td>
                                            <td><?= $obj -> particle_count_status ?></td>
                                            <td><?= $obj -> comment ?></td>
                                            <td><?= $obj -> fame_content_result ?> | <?= $obj -> fame_content_min ?> | <?= $obj -> fame_content_max ?></td>
                                            <td><?= $obj -> fame_status ?></td>
                                            <td><sub><?= $obj -> imported_at ?></sub></td>
                                         </tr>
                                        <?php
                                        }
                                        ?>
