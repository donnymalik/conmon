            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Oil Consumption </h3>
                        <div class="breadcrumb-wrapper">
                            <!--<span class="label">You are here:</span>-->
                            <ol class="breadcrumb">
                                <li class="active"> Oil Consumption </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-control">
                                    <a href="<?= base_url('admin/import_oil_consumption') ?>" class="btn btn-primary">
                                        <span class="fa fa-upload"></span> Import Oil Consumption...
                                    </a>
                                    <a href="<?= base_url('admin/kosongkan_data_oil_consumption') ?>" onclick="return confirm('Yakin kosongkan? Data tidak dapat dikembalikan.')" class="btn btn-default">
                                        <span class="fa fa-trash"></span> Kosongkan Data Oil Consumption
                                    </a>
                                </div>                                
                            ...
                            <div class="panel-body">
                                <table id="demo-dt-selection" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $no=0;
                                        foreach($data_oil_consumption as $obj){
                                            $no++;
                                        ?>
                                        <tr>
                                            <td><?= $no ?></td>
                                            ...
                                            <td><?= $obj -> oil_n_grease_type ?></td>
                                            <td><?= $obj -> code_unit ?></td>
                                            <td><?= $obj -> hm_per_km ?></td>
                                            <td><?= $obj -> komponen ?></td>
                                            <td><?= $obj -> remark ?></td>
                                            <td><?= $obj -> validasi_unit ?></td>
                                            <td><?= $obj -> lokasi ?></td>
                                            <td><?= $obj -> alat_berat ?></td>
                                         </tr>
                                        <?php
                                        }
                                        ?>
