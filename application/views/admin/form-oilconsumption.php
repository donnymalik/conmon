            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-upload"></i> Import Oil Consumption </h3>
                        <div class="breadcrumb-wrapper">
                            <!--<span class="label">You are here:</span>-->
                            <ol class="breadcrumb">
                                <li> <a href="<?= base_url('admin/oil_consumption') ?>"> Oil Consumption </a> </li>
                                <li class="active"> Import Oil Consumption </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-inline" method="post" action="<?= base_url("admin/upload_oil_consumption") ?>" enctype="multipart/form-data">                                   
                                    <div class="form-group">
                                        <label>File Excel: </label>               
                                    </div>
                                    <div class="form-group">            
                                        <input type="file" name="data_oil_consumption" required="">                
                                    </div>
                                    <div class="form-group">
