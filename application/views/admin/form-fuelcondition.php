            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-upload"></i> Import Record Fuel Condition </h3>
                        <div class="breadcrumb-wrapper">
                            <!--<span class="label">You are here:</span>-->
                            <ol class="breadcrumb">
                                <li> <a href="<?= base_url('admin/fuel_condition') ?>"> Fuel Condition </a> </li>
                                <li class="active"> Import Record Fuel Condition </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    Import Record Fuel Condition                                   
                                </h3>                               
                            </div>
                            <div class="panel-body">
                                <p>File excel yang diupload harus .xlsx</p>  
                                <form class="form-inline" method="post" action="<?= base_url("admin/upload_fuel_condition") ?>" enctype="multipart/form-data">                                   
                                    <div class="form-group">
                                        <label>File Excel: </label>               
                                    </div>
                                    <div class="form-group">            
                                        <input type="file" name="record_fuel_condition" required="">                
                                    </div>
                                    <div class="form-group">
