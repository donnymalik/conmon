            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> PPU </h3>
                        <div class="breadcrumb-wrapper">
                            <!--<span class="label">You are here:</span>-->
                            <ol class="breadcrumb">
                                <li class="active"> PPU </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-control">
                                    <a href="<?= base_url('admin/import_ppu') ?>" class="btn btn-primary">
                                        <span class="fa fa-upload"></span> Import PPU...
                                    </a>
                                    <a href="<?= base_url('admin/kosongkan_data_ppu') ?>" onclick="return confirm('Yakin kosongkan? Data tidak dapat dikembalikan.')" class="btn btn-default">
                                        <span class="fa fa-trash"></span> Kosongkan Data PPU
                                    </a>
                                </div>                                
                                ...
                                <table id="demo-dt-selection" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Link pitch LH</th>
                                            <th>Link pitch RH</th>
                                            <th>Link height LH</th>
                                            <th>Link height RH</th>
                                            <th>Bushing Link LH</th>
                                            <th>Bushing Link RH</th>
                                            <th>Shoe LH</th>
                                            <th>Shoe RH</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $obj -> egi ?></td>
                                            <td><?= $obj -> hm_ppu ?></td>
                                            <td><?= $obj -> link_pitch_lh ?></td>
                                            <td><?= $obj -> link_pitch_rh ?></td>
                                            <td><?= $obj -> link_height_lh ?></td>
                                            <td><?= $obj -> link_height_rh ?></td>
                                            <td><?= $obj -> bushing_link_lh ?></td>
                                            <td><?= $obj -> bushing_link_rh ?></td>
                                            <td><?= $obj -> shoe_lh ?></td>
                                            <td><?= $obj -> shoe_rh ?></td>
                                         </tr>
                                        <?php
