            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Record Fuel Consumption </h3>
                        <div class="breadcrumb-wrapper">
                            <!--<span class="label">You are here:</span>-->
                            <ol class="breadcrumb">
                                <li class="active"> Record Fuel Consumption </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-control">
                                    <a href="<?= base_url('admin/import_fuel_consumption') ?>" class="btn btn-primary">
                                        <span class="fa fa-upload"></span> Import Record Fuel Consumption...
                                    </a>
                                    <a href="<?= base_url('admin/kosongkan_data_fuel_consumption') ?>" onclick="return confirm('Yakin kosongkan? Data tidak dapat dikembalikan.')" class="btn btn-default">
                                        <span class="fa fa-trash"></span> Kosongkan Record Fuel Consumption
                                    </a>
                                </div>                                
                            ...
                            <div class="panel-body">
                                <table id="demo-dt-selection" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $no=0;
                                        foreach($data_fuel_consumption as $obj){
                                            $no++;
                                        ?>
                                        <tr>
                                            <td><?= $no ?></td>
                                            <td><?= $obj -> periode ?></td>
                                            <td><?= $obj -> liter_per_hour ?></td>
